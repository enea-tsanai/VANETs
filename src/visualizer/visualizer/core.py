...
class Visualizer(gobject.GObject):
    ...
    def __init__(self):
        ...
        self.buildings = {} # building index -> Node
    ...
    def scan_topology(self):
        ...
        print "scanning topology: %i buildings..." % (ns.buildings.BuildingList.GetNBuildings(),)
        ...
        seen_buildings = 0
        for buildingI in range(ns.buildings.BuildingList.GetNBuildings()):
            seen_buildings += 1
            building = ns.network.NodeList.GetNode(nodeI)
            building_name = "Building %i" % buildingI
            building_view = self.get_node(buildingI)
    ...
    def get_building(self, index):
        try:
            return self.buildings[index]
        except KeyError:
            print 'Building';
            building = Building(self, index)
